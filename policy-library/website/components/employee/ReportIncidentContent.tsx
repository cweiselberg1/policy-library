  ...
  if (success) {
    return (
      <div className="flex items-center justify-center py-32">
        <div className="bg-dark-800/50 backdrop-blur-xl border border-emerald-500/20 rounded-2xl p-8 max-w-md text-center">
          <div className="h-16 w-16 bg-emerald-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
            <ShieldExclamationIcon className="h-8 w-8 text-emerald-400" />
          </div>
  ...
  return (
    <div className="p-6 lg:p-10">
      <div className="mb-10">
        ...
        <p className="text-dark-400 text-sm mt-1">Submit a security or compliance incident</p>
      </div>

      <div className="max-w-4xl">
        <form onSubmit={handleSubmit} className="bg-dark-800/50 backdrop-blur-xl border border-dark-700/50 rounded-2xl p-8 space-y-6">
          <div>
            <label className="block text-dark-300 font-medium mb-2">
            ...
            <input
              ...
              className="w-full bg-dark-900/50 border border-dark-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-copper-500"
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full bg-dark-900/50 border border-dark-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-copper-500 resize-none"
          ...
          <div>
            <label className="block text-dark-300 font-medium mb-2">Location</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-dark-300 font-medium mb-2">
              Affected Systems
              <span className="text-dark-500 text-sm ml-2">(comma-separated)</span>
            </label>
            <input
              type="text"
          ...
          <div className="flex gap-4 pt-4">
            <button
              type="submit"
              disabled={submitting}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-copper-600 to-evergreen-600 text-white font-semibold rounded-xl hover:shadow-xl hover:shadow-copper-500/20 transition-all disabled:opacity-50"
            >
